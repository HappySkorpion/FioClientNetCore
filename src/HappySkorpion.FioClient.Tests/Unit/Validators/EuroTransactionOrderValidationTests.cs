...
{
    [Trait("Category", "Unit")]
    public class EuroTransactionOrderValidationTests
    {
        private EuroTransactionOrder GetValidOrder()
        {
            return new EuroTransactionOrder
            {
        ...
        public async Task Currency_NotEuro_Fail(CurrencyCode currency)
        {
            var order = GetValidOrder();
        ...
        [Fact]
        public async Task Bic_Empty_Pass()
        {
            var order = GetValidOrder();
            order.Bic = null;
